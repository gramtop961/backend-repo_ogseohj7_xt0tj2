...
app = FastAPI(title="Flames AI Agency Backend")
...
@app.get("/")
def read_root():
    return {"message": "Hello from FastAPI Backend!", "service": "ai-agency"}

@app.post("/lead")
def create_lead(lead: Lead) -> Dict[str, Any]:
    """Create a lead document from the landing page form."""
    try:
